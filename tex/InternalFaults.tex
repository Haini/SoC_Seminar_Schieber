...
The verification of the results in the voter and the selection of a healthy spare tile for reconfiguration don't pose a significant computational load on the system.
...
Should the lowest priority task already be reduced to its most economical form (in regard to consumed area), the process is repeated with the next higher priority task. 
