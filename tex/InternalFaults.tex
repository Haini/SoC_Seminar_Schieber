...
\end{figure}
\end{center}
\subsection{Task Based Architecture for \gls{DPR} by Wang et al.}
...
\end{figure}
\subsubsection{Fault prevention scheme}
...
\subsection{Task Based Architecture for \gls{DPR} by Sharma et al.}
