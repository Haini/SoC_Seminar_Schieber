...
The work of \cite{shanker_enhancing_nodate} identifies some obstacles that prevent \gls{DPR} in combination with \glspl{FPGA} for redundancy from a wider adaption through the industry and research.  
